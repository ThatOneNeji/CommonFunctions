...
/**
 * @class
 * @classdesc This is a description of the MessageBroker constructor function.
 */
class MessageBroker {
    ...
    init(options = {}) {
        ...
        //   let publishQueue;
        // this.externalHandover;


        this.Logging = options.logger;
        this.Logging.info('Initialising message broker');
        ...
        this.connection = amqp.connect(buildAMQPURL(settings));
